...
typedef enum {
	...
	*/
	...
	//AM, Aug 2015, added FFU channels
	A_FM_FFU_RPM,
	A_FM_FFU_PRESS,
	D_EFFM_FFU_STATUS,
	D_Bulkfill_Error			,
...
HANDLE		g_hLoadPortThread[3], g_hAMHSThread[3], g_hRobotThread, g_hAlignerThread, g_hStationThread[6];
...
typedef enum { LP_HOME , LP_LOAD , LP_UNLOAD , LP_CLAMP , LP_UNCLAMP , LP_CLOSE , LP_OPEN } LPx_CONTROL;
...
typedef enum { SANKYO , GENMARK } RB_TYPE;

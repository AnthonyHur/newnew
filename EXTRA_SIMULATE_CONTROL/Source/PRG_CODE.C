...
IO_Name_String_Map IO_STR_Map_Table[] = {
	...
	{ "Bubbler_Type"			, _K_D_IO	,	D_Bubbler_Type				,	0	} ,
	{ "Bubbler_Auto_Fill"		, _K_D_IO	,	D_Bubbler_Auto_Fill			,	0	} ,
	{ "Cont_Bubbler_Sensor_Usage", _K_D_IO	,	D_Cont_Bubbler_Sensor_Usage	,	0	} ,
	...
	{ "Aligner2Type"			, _K_D_IO,		D_Aligner2Type				,	0	},
	...
	{ "CTC.PM8_Wafer_Status",	_K_D_IO		,	D_CTC_PM8_Wafer_Status,		0		},
	...
	{ "PORT1_CanMap", _K_D_IO, D_PORT1_CanMap, 0 },
	{ "PORT2_CanMap", _K_D_IO, D_PORT2_CanMap, 0 },
	{ "PORT3_CanMap", _K_D_IO, D_PORT3_CanMap, 0 },

	{ "LP_Carrier_Capacity"		, _K_D_IO	,	D_LP_Carrier_Capacity		,	0	} ,
	...
	{ "FMRB_HOME"				, _K_D_IO	,	D_FMRB_HOME, 0 },
	{ "FMRB_SERVO"				, _K_D_IO	,	D_FMRB_SERVO				,	0	} ,	
	{ "FMRB_SPEED"				, _K_D_IO	,	D_FMRB_SPEED				,	0	} ,	
	...
	{ "RobotMotionState",		_K_D_IO,		D_RobotMotionState,			0 },
	{ "RobotMotionCompleteAck", _K_D_IO,		D_RobotMotionCompleteAck,	0 },
	{ "AlignerMotionCompleteAck", _K_D_IO,		D_AlignerMotionCompleteAck, 0 },
	
	//	Aligner
	//////////////////////////////////////////////////////////////////////////
	{ "PreAlignerRunSts"		, _K_D_IO	,	D_PreAlignerRunSts			,	0	} ,
	{ "PreAlignerVacSts"		, _K_D_IO	,	D_PreAlignerVacSts			,	0	} ,
	{ "PreAlignerVacValveSts",	_K_D_IO		,	D_PreAlignerVacValveSts, 0 },
	...
	{ "AlignerMotionState",		_K_D_IO,	D_AlignerMotionState, 0 },
	...
	{ "Bubbler2_ManualVvSts"	, _K_D_IO	,	D_Bubbler2_ManualVvSts		,	0	} ,
	...
	{ "ContBubbler2_Level"		, _K_A_IO	,	A_ContBubbler2_Level		,	0	} ,
	{ "ContBubbler_Refill"		, _K_D_IO	,	D_ContBubbler_Refill		,	0	} ,
	...
	*/
	...
	{ "Bubbler2_Fill_Vv"		, _K_D_IO	,	D_Bubbler2_Fill_Vv			,	0	},
	...
	//Frame aligner
	{ "FrameAligner_RunSts", _K_D_IO, D_FrameAligner_RunSts, 0 },
	{ "FrameAligner_ServoSts", _K_D_IO, D_FrameAligner_ServoSts, 0 },
	{ "FrameAligner_ErrText", _K_S_IO, S_FrameAligner_ErrText, 0 },
	{ "FrameAligner_Initialize", _K_D_IO, D_FrameAligner_Initialize, 0 },
	{ "FrameAligner_Align", _K_D_IO, D_FrameAligner_Align, 0 },
	
	{ "FrameAligner_MoveToZero", _K_D_IO, D_FrameAligner_MoveToZero, 0 },
	{ "FrameAligner_AlignmentState", _K_D_IO, D_FrameAligner_AlignmentState, 0 },
	{ "FrameAligner_AlignCompleteAck", _K_D_IO, D_FrameAligner_AlignCompleteAck, 0 },
	{ "FrameAligner_Online", _K_D_IO, D_FrameAligner_Online, 0 },
	//{ "FrameAligner_AngleSet", _K_A_IO, A_FrameAligner_AngleSet, 0 },
	{ "FrameAligner_Pos_Degree", _K_A_IO, A_FrameAligner_Pos_Degree, 0 },
	{ "FrameAligner_LastAlState", _K_D_IO, D_FrameAligner_LastAlState, 0 },
	{ "FrameAligner_MotionState", _K_D_IO, D_FrameAligner_MotionState, 0 },
	{ "FrameAligner_MotionCompleteAck", _K_D_IO, D_FrameAligner_MotionCompleteAck, 0 },
	{ "FrameAligner_HomingState", _K_D_IO, D_FrameAligner_HomingState, 0 },
	{ "FrameAligner_NotchFound", _K_D_IO, D_FrameAligner_NotchFound, 0 },
	

	//Festo inputs
	{ "FrameA_CDA_Input", _K_D_IO, D_FrameA_CDA_Input, 0 },
	{ "FrameA_FingersEngagedState", _K_D_IO, D_FrameA_FingersEngagedState, 0 },
	{ "FrameA_FingersDisengagedState", _K_D_IO, D_FrameA_FingersDisengagedState, 0 },

	{ "FrameA_BackSensorState", _K_D_IO, D_FrameA_BackSensorState, 0 },
	{ "FrameA_LeftSensorState", _K_D_IO, D_FrameA_LeftSensorState, 0 },
	{ "FrameA_RightSensorState", _K_D_IO, D_FrameA_RightSensorState, 0 },
	{ "FrameA_FrontSensorState", _K_D_IO, D_FrameA_FrontSensorState, 0 },
	//{ "FrameA_FingersIn", _K_D_IO, D_FrameA_FingersIn, 0 },
	//{ "FrameA_FingersOut", _K_D_IO, D_FrameA_FingersOut, 0 },
	{ "FrameA_WaferPresent", _K_D_IO, D_FrameA_WaferPresent, 0 },

	//Festo outputs
	{ "FrameA_SV1_FingersEngage", _K_D_IO, D_FrameA_SV1_FingersEngage, 0 },
	{ "FrameA_SV2_FingersDisengage", _K_D_IO, D_FrameA_SV2_FingersDisengage, 0 },

	{ "LP_Wafer_Size", _K_D_IO, D_LP_Wafer_Size, 0 },
	{ "Wafer_Size", _K_D_IO, D_Wafer_Size, 0 },
	...
	{ "Conv_Purge_Vv_Sts",    _K_D_IO, D_Conv_Purge_Vv_Sts, 0 },
	{ "Conv2_Purge_Vv_Sts",   _K_D_IO, D_Conv2_Purge_Vv_Sts, 0 },

    {  "VacPump_Exh_IO",			_K_D_IO, D_VacPump_Exh_IO, 0 },
    {  "Smoke_Detector_Sts",		_K_D_IO, D_Smoke_Detector_Sts, 0 },
    {  "PD_Box_DC_Fan_Sts",			_K_D_IO, D_PD_Box_DC_Fan_Sts, 0 },
    {  "PM_ELT_Box_DC_Fan_Sts",		_K_D_IO, D_PM_ELT_Box_DC_Fan_Sts, 0 },
    {  "Ionizer2_Status",			_K_D_IO, D_Ionizer2_Sts, 0 },
	{ "CDA_Pressure_Ionizer1",		_K_A_IO, A_CDA_Pressure_Ionizer1, 0	},
	{ "CDA_Pressure_Ionizer2",		_K_A_IO, A_CDA_Pressure_Ionizer2, 0	},

	{ "PM_Press_Units",				_K_D_IO, D_PM_Press_Units, 0 },
	{ "VAC_ONOFF", _K_D_IO, D_VAC_ONOFF, 0 },
...
Module_Status Program_Main()
{
	...
	double		dr , dl;
	unsigned	uLoadPort_SimulatorThreadID[3]={0,}, uRobot_SimulatorThreadID, uAligner_SimluatorThreadID, uStation_SimluatorThreadID;
	unsigned	uAMHS_SimulatorThreadID[3] = { 0, }, uDiscMotion_SimluatorThreadID, uPress_SimluatorThreadID, uAutFill_SimluatorThreadID, uFrAligner_SimluatorThreadID;
	unsigned	uWS_SimluatorThreadID[2] = { 0, };

	// Note: if this function is included (uncommented) and is RUN then we assume that Setup2 has been told to turn on simulation.  
	// In order to support hybrid simulation it may also have set IO_Driver_Loding to LOAD (which would clear the gSessionInfo.IsSimulationEnabled)
	// As such all related tests have been removed from this function so that it may be used in LOAD and UNLOAD modes

	const char *ioDriverLoadUnloadStrP = (gSessionInfo.IO_Driver_Loding == S_IODrvLoad_LOAD ? " LOAD " : "UNLOAD");

	printf("###################################################################\n");
	printf("##                                                              ###\n");
	printf("##                  [WARNING] SIMULATION TEST                   ###\n");
	printf("##                          [%s]                            ###\n", ioDriverLoadUnloadStrP);
	printf("###################################################################\n");
	...
	if (!(gSessionInfo.IsUsingVisionLPMs || gSessionInfo.IsUsingFixloadLPMs || gSessionInfo.IsUsingSimulationLPMs))
	{
		printf("Starting LoadPort Simulators...\n");

		// When the VisionLPMs are selected in simulation, we assume that the user is intending to use them with an external emulator.
		...
		printf("Starting AMHS Simulators...\n");
	...
	if (gSessionInfo.RobotType != RB_Type_SIMULATION)
	{
		printf("Starting Robot Simulator...\n");
	...
	if (gSessionInfo.AlignerType != AL_Type_SIMULATION)
	{
		printf("Starting Aligner Simulator...\n");
	...
	g_hFrAlignerThread = NULL;
	if (READ_DIGITAL(D_Aligner2Type, &nCommStatus) > 0)
	{
		printf("Starting Aligner2 Simulator [Frame] ...\n");

		g_hFrAlignerThread = (HANDLE)_beginthreadex(NULL, 0, (void *)FrAligner_Simulator, NULL, 0, &uFrAligner_SimluatorThreadID);
		if (g_hFrAlignerThread == NULL)
		{
			printf("[ERROR] Frame Aligner_Simulator Thread is not created.\n");
			return SYS_ABORTED;
		}
	}

	if (gSessionInfo.IO_Driver_Loding == S_IODrvLoad_UNLOAD)
	{
		printf("Starting Disc_Motion Simulator...\n");

		// this function is only used to perform Disc Motion Simulation if we are running in old traditional IO_Driver_Loding UNLOAD mode.  
		// In all other cases we are using driver level simulation and should not activate simulation of the disc's motion here.
	...
	printf("Starting Pressure Simulator...\n");
	...
	if (READ_DIGITAL(D_Bubbler_Type, &nCommStatus) == AUTOFILL_BUBBLER)
	{
		printf("Starting AutoFill Simulator...\n");
	...
	{
		printf("Starting WetStation Simulators...\n");
	...
	printf("Starting Station Simulators...\n");
		...
		(g_hStationThread[3] == NULL) || (g_hStationThread[4] == NULL) || (g_hStationThread[5] == NULL))
	{
 	...
 	while ( TRUE )
 	{
		...
		{
			// NOTE: D_VacHeat_ExhstISOSts are normally open valves
			WRITE_DIGITAL( D_VacHeat_PrcGasISOSts , nReadData , &nCommStatus );
			WRITE_DIGITAL( D_VacHeat_ExhstISOSts, !nReadData, &nCommStatus );
		}
		
		nReadData = READ_DIGITAL( D_VacHeat_GasIsoB_Vv , &nCommStatus );
		WRITE_DIGITAL( D_VacHeat_GasIsoB_Sts , nReadData , &nCommStatus );

		nReadData = READ_DIGITAL( D_VacHeat_VacIsoB_Vv , &nCommStatus );
		WRITE_DIGITAL( D_VacHeat_VacIsoB_Sts , nReadData , &nCommStatus );
		...
		WRITE_DIGITAL( D_Conv_Purge_Vv_Sts , nReadData , &nCommStatus );
		WRITE_DIGITAL( D_Conv2_Purge_Vv_Sts , nReadData , &nCommStatus );
		...
		if (gSessionInfo.IsGenevaBOptionInstalled)
		{
			dl = READ_ANALOG( A_MFC3_Set , &nCommStatus );
			dr = READ_ANALOG( A_MFC6_Set , &nCommStatus );
			if ( READ_DIGITAL( D_Bubbler2_DlvryVv_Sts , &nCommStatus ) == 1 )
			{
				WRITE_ANALOG( A_MFC3_Monitor , dl , &nCommStatus );
				WRITE_ANALOG( A_MFC6_Monitor , dr , &nCommStatus );
			}
			else
			{
				WRITE_ANALOG( A_MFC3_Monitor , 0.0 , &nCommStatus );
				WRITE_ANALOG( A_MFC6_Monitor , 0.0 , &nCommStatus );
			}
		}
...
// This method is used to look for dynamic changes in the set of things that should be simulated.  Currently this is focused on ocasionally updating g_SimulateConvectrons
...
int g_SimulateConvectrons = 1;	// This flag gets cleared any time the ServiceSimulateFlags sees that the S_Convect_Revision is a non-empty string - which happens if the serial Convectron Driver is running and connects to an actual device.
